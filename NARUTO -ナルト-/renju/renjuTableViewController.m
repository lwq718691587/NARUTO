...
#import "renjuTableViewController.h"

@interface renjuTableViewController ()

@property(nonatomic,strong)NSArray * dataArr;

@end

@implementation renjuTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.dataArr = @[@"3",@"3",@"3",@"3",@"3",@"3",@"3",@"3",@"3"];
